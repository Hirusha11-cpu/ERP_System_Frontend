...
const Invoice_shirmila = () => {
  ...
  const handleSubmit = async () => {
    ...
    const prefix = countryOptions.find(c => c.code === formData.invoice.country)?.prefix || 'IN';
  ...
  const [formData, setFormData] = useState({
    ...
    payment: {
      type: 'non-credit',
      collectionDate: new Date(Date.now() + 30 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
  ...
  const handleCurrencyChange = (currency) => {
    let rate = 87.52;
    switch(currency) {
      case 'SGD': rate = 65.32; break;
      case 'MYR': rate = 21.05; break;
      case 'LKR': rate = 0.29; break;
      case 'INR': rate = 1.00; break;
      default: rate = 87.52;
    }
  ...
  const calculateTotals = () => {
    ...
    // Calculate total
    const total = subTotal + handlingFee + gst + formData.totals.additionalTax + formData.totals.bankCharges;
  ...
  return (
    <div className="container py-4">
      {/* Header */}
      <div className="header text-center bg-dark text-white p-4 mb-4 rounded">
        <div className="company-name fs-2 fw-bold">SHARMILA TOURS & TRAVELS</div>
        <div className="company-details mt-2">
          Shop No: 1st Floor, 10, Venkatraman Road, Kamala Second Street<br />
          Chinna Chokkikulam, Madurai - 625002<br />
          Tel: +91 0452 405 8375/403-4704 | Email: chennai@Sharmilatravels.com<br />
          Service Tax (Registration No.): ADVT544290 | GSTIN: 33ADVT544290TZV
        </div>
      </div>
      ...
      <Card className="mb-4">
        <Card.Body>
          <h5 className="section-title fw-semibold mb-3 pb-2 border-bottom">Invoice Information</h5>
                    ...
                    <Col md={6} className="mb-3">
                      <Form.Group>
                        ...
                        <Form.Select 
                          ...
                          onChange={(e) => handleInputChange('invoice', 'country', e.target.value)}
                        >
                      ...
                      <Form.Group>
                        ...
                        <div className="input-group">
                          <span className="input-group-text">
                            {countryOptions.find(c => c.code === formData.invoice.country)?.prefix || 'IN'}
                          </span>
                          <Form.Control 
                            type="text" 
                    ...
                    <Col md={6} className="mb-3">
                      <Form.Group>
                        ...
                        <Form.Control 
                          ...
                          onChange={(e) => handleInputChange('invoice', 'issueDate', e.target.value)}
                        />
                      </Form.Group>
                    </Col>
                    ...
                    <Col md={6} className="mb-3">
                      <Form.Group>
                        ...
                        <Form.Control 
                          ...
                          onChange={(e) => handleInputChange('invoice', 'yourRef', e.target.value)}
                        />
                      </Form.Group>
                    </Col>
                    ...
                    <Col md={6} className="mb-3">
                      <Form.Group>
                        ...
                        <Form.Control 
                          ...
                          onChange={(e) => handleInputChange('invoice', 'salesId', e.target.value)}
                        />
                      </Form.Group>
                    </Col>
                    ...
                    <Col md={6} className="mb-3">
                      <Form.Group>
                        ...
                        <Form.Control 
                          ...
                          onChange={(e) => handleInputChange('invoice', 'printedBy', e.target.value)}
                        />
                      </Form.Group>
                    </Col>
                  </Row>
      ...
      <Card className="mb-4">
        <Card.Body>
          <h5 className="section-title fw-semibold mb-3 pb-2 border-bottom">Currency Details</h5>
              ...
              <Form.Group>
                ...
                <div className="input-group">
                  <Form.Control 
                    ...
                    onChange={(e) => handleNestedInputChange('currencyDetails', 'exchangeRate', parseFloat(e.target.value))}
                  />
                  <Button 
      ...
      <Card className="mb-4">
        <Card.Body>
              ...
              <tbody>
                {formData.serviceItems.map(item => (
                  <tr key={item.id}>
                    ...
                    <td>
                      <Button variant="danger" size="sm" onClick={() => deleteItem(item.id, 'service')}>
                        <FaTrash />
                      </Button>
                    </td>
                  </tr>
          ...
          {formData.currencyDetails.currency === 'INR' && (
            <div className="mt-3">
              <strong>Handling Fee:</strong> {formData.totals.handlingFee.toFixed(2)}
            </div>
          )}
        </Card.Body>
      </Card>
      ...
      <Card className="mb-4">
        <Card.Body>
          <div className="d-flex justify-content-between align-items-center mb-3">
            <h5 className="section-title fw-semibold mb-0">Additional Charges</h5>
              ...
              <tbody>
                {formData.additionalCharges.map(charge => (
                  <tr key={charge.id}>
                    ...
                    <td>
                      <Button variant="danger" size="sm" onClick={() => deleteItem(charge.id, 'charge')}>
                        <FaTrash />
                      </Button>
                    </td>
                  </tr>
      ...
      <Card className="mb-4">
        <Card.Body>
          <h5 className="section-title fw-semibold mb-3 pb-2 border-bottom">Account Details</h5>
            ...
            <Col md={4} className="mb-3">
              <Form.Group>
                ...
                <Form.Control 
                  ...
                  onChange={(e) => handleNestedInputChange('accountDetails', 'name', e.target.value)}
                />
              </Form.Group>
            </Col>
            ...
            <Col md={4} className="mb-3">
              <Form.Group>
                ...
                <Form.Control 
                  ...
                  onChange={(e) => handleNestedInputChange('accountDetails', 'number', e.target.value)}
                />
              </Form.Group>
            </Col>
            ...
            <Col md={4} className="mb-3">
              <Form.Group>
                ...
                <Form.Control 
                  ...
                  onChange={(e) => handleNestedInputChange('accountDetails', 'bank', e.target.value)}
                />
              </Form.Group>
            </Col>
            ...
            <Col md={4} className="mb-3">
              <Form.Group>
                ...
                <Form.Control 
                  ...
                  onChange={(e) => handleNestedInputChange('accountDetails', 'branch', e.target.value)}
                />
              </Form.Group>
            </Col>
            ...
            <Col md={4} className="mb-3">
              <Form.Group>
                ...
                <Form.Control 
                  ...
                  onChange={(e) => handleNestedInputChange('accountDetails', 'ifsc', e.target.value)}
                />
              </Form.Group>
            </Col>
            ...
            <Col md={4} className="mb-3">
              <Form.Group>
                ...
                <Form.Control 
                  ...
                  onChange={(e) => handleNestedInputChange('accountDetails', 'address', e.target.value)}
                />
              </Form.Group>
            </Col>
          </Row>
      ...
      <Card className="mb-4">
        <Card.Body>
          <h5 className="section-title fw-semibold mb-3 pb-2 border-bottom">Tax Calculation & Totals</h5>
                  ...
                  <Form.Group className="mb-3">
                    <div className="d-flex gap-3">
                      <Form.Check 
                        ...
                        onChange={() => handleInputChange('payment', 'type', 'credit')}
                      />
                      <Form.Check 
                        type="radio"
                        ...
                        onChange={() => handleInputChange('payment', 'type', 'non-credit')}
                      />
                    </div>
                  </Form.Group>
                    ...
                    <div id="collectionDetails">
                        ...
                        <Col md={6} className="mb-3">
                          <Form.Group>
                            ...
                            <Form.Control 
                              ...
                              onChange={(e) => handleNestedInputChange('payment', 'collectionDate', e.target.value)}
                            />
                          </Form.Group>
                        </Col>
                      </Row>
                      ...
                      <Form.Group className="mb-3">
                        ...
                        <Form.Control 
                          ...
                          onChange={(e) => handleNestedInputChange('payment', 'instructions', e.target.value)}
                        />
                      </Form.Group>
                    </div>
                  )}
                    ...
                    <Col md={6} className="mb-3">
                      <Form.Group>
                        ...
                        <Form.Control 
                          ...
                          onChange={(e) => handleNestedInputChange('payment', 'staff', e.target.value)}
                        />
                      </Form.Group>
                    </Col>
                    ...
                    <Col md={6} className="mb-3">
                      <Form.Group>
                        ...
                        <Form.Control 
                          ...
                          onChange={(e) => handleNestedInputChange('payment', 'remarks', e.target.value)}
                        />
                      </Form.Group>
                    </Col>
                  </Row>
                    ...
                    <Row>
                      ...
                      <Col md={3}>
                        <Form.Check 
                          ...
                          onChange={(e) => handlePaymentMethodChange('googlePay', e.target.checked)}
                        />
                      </Col>
                      <Col md={3}>
                        <Form.Check 
                          ...
                          onChange={(e) => handlePaymentMethodChange('usdPortal', e.target.checked)}
                        />
                      </Col>
                    </Row>
                  </Form.Group>
                ...
                <Card.Body>
                  ...
                  {formData.currencyDetails.currency === 'INR' && (
                    <>
                      ...
                      <div className="d-flex justify-content-between mb-2 pb-2 border-bottom bg-light">
                        <span>GST @ {formData.taxRates.find(tax => tax.name === 'GST')?.rate || 0}%:</span>
                  ...
                  <div className="d-flex justify-content-between mb-2 pb-2 border-bottom bg-light">
                    ...
                    <Form.Control 
                      ...
                      onChange={(e) => handleInputChange('totals', 'additionalTax', parseFloat(e.target.value) || 0)}
                    />
                  </div>
                  ...
                  <div className="d-flex justify-content-between mb-2 pb-2 border-bottom">
                    ...
                    <Form.Control 
                      ...
                      onChange={(e) => handleInputChange('totals', 'bankCharges', parseFloat(e.target.value) || 0)}
                    />
                  </div>
                  ...
                  <div className="d-flex justify-content-between mb-2 pb-2 border-bottom">
                    ...
                    <Form.Control 
                      ...
                      onChange={(e) => handleInputChange('totals', 'amountReceived', parseFloat(e.target.value) || 0)}
                    />
                  </div>
      ...
      {/* Exchange Rate Modal */}
      <Modal show={showExchangeModal} onHide={() => setShowExchangeModal(false)}>
        ...
        <Modal.Body>
          <Form.Group className="mb-3">
            ...
            <Form.Select 
              ...
              onChange={(e) => handleNestedInputChange('currencyDetails', 'rateSource', e.target.value)}
            >
          ...
          {formData.currencyDetails.rateSource === 'custom' ? (
            <Form.Group className="mb-3" id="customRateGroup">
              ...
              <Form.Control 
                ...
                onChange={(e) => handleNestedInputChange('currencyDetails', 'customRate', parseFloat(e.target.value))}
              />
            </Form.Group>
          ) : (
            <div className="mb-3" id="xeRateGroup">
              <p>Current XE.com rate: <span>87.52</span></p>
              <Form.Check 
                type="checkbox"
                label="Add +1 to rate (standard for all currencies except LKR)"
                checked={formData.currencyDetails.addOneToRate}
                onChange={(e) => handleNestedInputChange('currencyDetails', 'addOneToRate', e.target.checked)}
              />
              <Form.Check 
                type="checkbox"
                label="Add +10 to rate (for USD to LKR only)"
                checked={formData.currencyDetails.addTenToRate}
                onChange={(e) => handleNestedInputChange('currencyDetails', 'addTenToRate', e.target.checked)}
              />
            </div>
          )}
        </Modal.Body>
                ...
                <Col md={6} className="mb-3">
                  <Form.Group>
                    ...
                    <Form.Control 
                      ...
                      onChange={(e) => setNewItem({...newItem, checkin: e.target.value})}
                    />
                  </Form.Group>
                </Col>
                ...
                <Col md={6} className="mb-3">
                  <Form.Group>
                    ...
                    <Form.Control 
                      ...
                      onChange={(e) => setNewItem({...newItem, checkout: e.target.value})}
                    />
                  </Form.Group>
                </Col>
        ...
        <Modal.Body>
          ...
          <Form.Group className="mb-3">
            <Form.Check 
              ...
              onChange={(e) => setNewCharge({...newCharge, taxable: e.target.checked})}
            />
          </Form.Group>
        </Modal.Body>
        <Modal.Footer>
        ...
        <Modal.Body>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control 
              ...
              onChange={(e) => setNewTaxRate({...newTaxRate, component: e.target.value})}
            />
          </Form.Group>
        ...
        <Modal.Body className="p-0">
          <div id="invoice-preview-content" className="invoice-preview p-4">
            ...
            <div className="text-center mb-3">
              ...
              <div className="mb-1">Shop No:1st Floor,10,Venkatraman Road,Kamala Second street</div>
              ...
              <div className="mb-1">Service Tax Registration No.: ADVT544290</div>
              ...
              <div className="notice-box p-2 mb-3 text-start bg-warning bg-opacity-10 border-start border-warning border-4">
                <strong>STRICTLY TO BE NOTED:</strong> Finance bill 2017 proposes to insert Section 269ST in the Income tax Act that restricts receiving an amount of Rs 2,00,000/- or more. Sharmila Travels will not accept any cash deposit effective 1st April 2017. If trade partners make cash deposit, then the amount will be ignored and use other payment modes such as Cheque deposit, RTGS & NEFT for all your future bookings with Sharmila Travels.
              </div>
            ...
            {/* Items Table */}
            <table className="table table-bordered mb-3" style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr style={{ backgroundColor: '#343a40', color: 'white' }}>
                  <th style={{ padding: '8px', textAlign: 'left' }}>Description</th>
                  <th style={{ padding: '8px', textAlign: 'right' }}>Unit Fare</th>
                ...
                {formData.serviceItems.map(item => (
                  <tr key={item.id}>
                    ...
                    <td style={{ padding: '8px', textAlign: 'right', borderBottom: '1px solid #ddd' }}>
                      {formData.currencyDetails.currency === 'INR' ? '₹' : '$'}{item.price.toFixed(2)}
                    </td>
                    <td style={{ padding: '8px', textAlign: 'right', borderBottom: '1px solid #ddd' }}>{item.discount}%</td>
                    <td style={{ padding: '8px', textAlign: 'right', borderBottom: '1px solid #ddd' }}>{item.qty}</td>
                    <td style={{ padding: '8px', textAlign: 'right', borderBottom: '1px solid #ddd' }}>
                      {formData.currencyDetails.currency === 'INR' ? '₹' : '$'}{item.total.toFixed(2)}
                    </td>
                  </tr>
                ))}
              </tbody>
            ...
            <div className="mb-4">
              ...
              <div><strong>ACCOUNT NAME:</strong> {formData.accountDetails.name}</div>
              <div><strong>ACCOUNT NO:</strong> {formData.accountDetails.number}</div>
              <div><strong>BANK:</strong> {formData.accountDetails.bank}</div>
              <div><strong>BRANCH:</strong> {formData.accountDetails.branch}</div>
              <div><strong>IFSC CODE:</strong> {formData.accountDetails.ifsc}</div>
              <div><strong>Bank Address:</strong> {formData.accountDetails.address}</div>
            </div>
            ...
            <div className="row mb-4">
              <div className="col-md-6 offset-md-6">
                <table style={{ width: '100%' }}>
                  <tr>
                    <td style={{ padding: '4px', textAlign: 'right' }}><strong>Sub Total:</strong></td>
                    <td style={{ padding: '4px', textAlign: 'right' }}>
                      {formData.currencyDetails.currency === 'INR' ? '₹' : '$'}{formData.totals.subTotal.toFixed(2)}
                    </td>
                  </tr>
                  ...
                  {formData.currencyDetails.currency === 'INR' && (
                    <>
                      <tr>
                        <td style={{ padding: '4px', textAlign: 'right' }}><strong>CGST of 9.00%:</strong></td>
                        <td style={{ padding: '4px', textAlign: 'right' }}>₹{(formData.totals.gst / 2).toFixed(2)}</td>
                      </tr>
                      <tr>
                        <td style={{ padding: '4px', textAlign: 'right' }}><strong>SGST of 9.00%:</strong></td>
                        <td style={{ padding: '4px', textAlign: 'right' }}>₹{(formData.totals.gst / 2).toFixed(2)}</td>
                      </tr>
                    </>
                  )}
                  ...
                  <tr>
                    <td style={{ padding: '4px', textAlign: 'right' }}><strong>Total:</strong></td>
                    <td style={{ padding: '4px', textAlign: 'right' }}>
                      {formData.currencyDetails.currency === 'INR' ? '₹' : '$'}{formData.totals.total.toFixed(2)}
                    </td>
                  </tr>
                  <tr>
                    <td style={{ padding: '4px', textAlign: 'right' }}><strong>Amount Received:</strong></td>
                    <td style={{ padding: '4px', textAlign: 'right' }}>
                      {formData.currencyDetails.currency === 'INR' ? '₹' : '$'}{formData.totals.amountReceived.toFixed(2)}
                    </td>
                  </tr>
                  <tr>
                    <td style={{ padding: '4px', textAlign: 'right' }}><strong>Balance:</strong></td>
                    <td style={{ padding: '4px', textAlign: 'right' }}>
                      {formData.currencyDetails.currency === 'INR' ? '₹' : '$'}{formData.totals.balance.toFixed(2)}
                    </td>
                  </tr>
                </table>
              </div>
...
export default Invoice_shirmila;